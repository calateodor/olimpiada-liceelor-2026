...
export const EVENTS: OlEvent[] = [
  ...
  { id: 'majorete', name: 'Majorete', subtitle: '+ mascotă', section: 'artistic', format: 'ranking', icon: '📣', venue: 'Stadionul 1 Mai', venueId: 'stadion-1-mai', dateLabel: '28 septembrie', startDate: '2026-09-28', endDate: '2026-09-28', time: '17:00', regulationSlug: 'majorete', description: 'Programul de majorete și mascota fiecărui liceu, pe gazonul Stadionului 1 Mai, înainte de finalele de fotbal.', teamSize: 'max. 14 eleve + mascotă', finished: false },
...
const CAL: TeamSportCal[] = [
  { id: 'fotbal', venue: 'Baza Sportivă Dumitru Dobrescu', groupDays: ['2026-09-14', '2026-09-16', '2026-09-17'], sf: { date: '2026-09-21', t1: '14:00', t2: '15:00', venue: 'Stadionul 1 Mai' }, finals: { date: '2026-09-28', t3: '16:00', t1: '18:00', venue: 'Stadionul 1 Mai' } },
  { id: 'volei', venue: 'Liceul Nicolae Titulescu', groupDays: ['2026-09-15', '2026-09-17', '2026-09-18'], sf: { date: '2026-09-21', t1: '17:00', t2: '18:00' }, finals: { date: '2026-09-24', t3: '16:00', t1: '17:00', venue: 'Colegiul Național Radu Greceanu' } },
  { id: 'handbal', venue: 'Liceul cu Program Sportiv', groupDays: ['2026-09-14', '2026-09-16', '2026-09-21'], days: { 2: { slots: ['16:00', '17:00', '18:00'], order: [1, 2, 0] } }, sf: { date: '2026-09-22', t1: '16:30', t2: '17:30' }, finals: { date: '2026-09-23', t3: '15:00', t1: '16:00' } },
