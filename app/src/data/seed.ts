...
export const EVENTS: OlEvent[] = [
  ...
  { id: 'tenis-f', name: 'Tenis de masă', subtitle: 'fete', section: 'sport', format: 'knockout', icon: '🏓', venue: 'Liceul cu Program Sportiv', venueId: 'lps', dateLabel: '1 octombrie', startDate: '2026-10-01', endDate: '2026-10-01', time: '10:00', regulationSlug: 'tenis-de-masa', description: 'Sistem eliminatoriu, tablou stabilit prin tragere la sorți. Cel mai bun din 3 seturi, seturi până la 11.', teamSize: '1 elevă', finished: false },
  { id: 'tenis-b', name: 'Tenis de masă', subtitle: 'băieți', section: 'sport', format: 'knockout', icon: '🏓', venue: 'Liceul cu Program Sportiv', venueId: 'lps', dateLabel: '1 octombrie', startDate: '2026-10-01', endDate: '2026-10-01', time: '10:00', regulationSlug: 'tenis-de-masa', description: 'Sistem eliminatoriu, tablou stabilit prin tragere la sorți. Cel mai bun din 3 seturi, seturi până la 11.', teamSize: '1 elev', finished: false },
  ...
  { id: 'galerie', name: 'Galerie', subtitle: 'suporteri', section: 'artistic', format: 'ranking', icon: '🥁', venue: 'În tribune, la toate probele', dateLabel: 'toată competiția', startDate: '2026-09-14', endDate: '2026-10-03', regulationSlug: 'galerie', description: 'Cea mai zgomotoasă, mai creativă și mai fair-play galerie din tribune ia puncte pentru liceul ei.', finished: false },
  { id: 'miss', name: 'Miss', subtitle: 'Olimpiada Liceelor', section: 'artistic', format: 'ranking', icon: '👑', venue: 'Scena de pe Esplanadă', venueId: 'esplanada', dateLabel: '3 octombrie', startDate: '2026-10-03', endDate: '2026-10-03', time: '18:00', regulationSlug: 'miss-mister', description: 'Ținută casual, ținută elegantă, talent, dans pe colaj impus și întrebări de cultură generală. Juriul notează de la 1 la 5.', teamSize: '1 elevă', finished: false },
  { id: 'mister', name: 'Mister', subtitle: 'Olimpiada Liceelor', section: 'artistic', format: 'ranking', icon: '🎩', venue: 'Scena de pe Esplanadă', venueId: 'esplanada', dateLabel: '3 octombrie', startDate: '2026-10-03', endDate: '2026-10-03', time: '18:00', regulationSlug: 'miss-mister', description: 'Ținută casual, ținută elegantă, talent, dans pe colaj impus și întrebări de cultură generală. Juriul notează de la 1 la 5.', teamSize: '1 elev', finished: false },
...
export const SEED: State = {
  ...
  config: {
    ...
    heroTagline: '7 licee · 15 probe · 3 săptămâni',
    showRosters: false,
    ...
    home: { ticker: true, roadmap: true, standings: true, probes: true, concert: true },
    tickerMessages: [],
  ...
  photos: [],
  timeline: [
    { id: 'tl-hcl', date: '2026-06-18T12:00:00+03:00', title: 'Consiliul Local aprobă ediția 2026', body: 'Olimpiada Liceelor revine cu 15 probe sportive, artistice și de voluntariat.', kind: 'milestone' },
