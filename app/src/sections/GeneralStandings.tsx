      ...
      <div className="container">
        {!full && (
          <div className="sec-head">
            ...
            <p className="aside body">Locul I aduce 10 puncte, locul II 8, locul III 6, la fiecare dintre cele 14 probe. Suma decide trofeul cel mare. {counted > 0 ? `${counted} probe punctate până acum.` : 'Nicio probă punctată încă — totul e deschis.'}</p>
          </div>
        )}
