...
export default function Highlights() {
  ...
  return (
    <div className="page" style={{ paddingBottom: 'var(--s24)' }}>
      <PageHead idx={`Highlights · ${state.photos.length} fotografii`} title="Din tribune și de pe teren" lead="Fotografii din fiecare probă și din fiecare liceu, încărcate pe măsură ce se întâmplă.">
      ...
      <div className="container"><PhotoGrid photos={list} emptyText="Primele highlights apar odată cu primul fluier, pe 14 septembrie." /></div>
    </div>
  );
}
