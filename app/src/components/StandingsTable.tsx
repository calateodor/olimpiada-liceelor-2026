...
/* Clasamentul unei grupe: meciuri, victorii, egaluri, înfrângeri, puncte.
   Golurile/seturile marcate și primite nu se afișează — rămân doar în calcul, ca departajare
   după rezultatul direct (vezi groupStandings). */
  ...
  return (
    <div className="table-wrap">
      <table className="table">
        ...
        <thead>
          <tr><th>#</th><th>Echipa</th><th className="c">M</th><th className="c">V</th>{hasDraw && <th className="c">E</th>}<th className="c">Î</th><th className="c">P</th></tr>
        </thead>
        <tbody>
          {rows.map((r, i) => (
